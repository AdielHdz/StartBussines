  ...
  >
    ...
    <div className="flex flex-col items-center justify-center h-screen text-white px-8 py-20">
      ...
      <div className="fixed bottom-0 left-0 w-full flex justify-center items-center bg-primary p-4">
        <button className="btn bg-primary hover:bg-secondary text-white font-bold py-3 px-6 rounded-lg m-2 text-lg transition-all duration-200">
          Login
        </button>
        <button className="btn bg-secondary hover:bg-primary text-white font-bold py-3 px-6 rounded-lg m-2 text-lg transition-all duration-200">
          Registro
        </button>
      </div>
    </div>
