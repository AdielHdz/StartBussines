  ...
  return (
    <div>
      <div className="relative">
        ...
        <p class=" absolute top-[8rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
        ...
        {/* <div className="absolute top-[32rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">
          {currentUser.user_role === "entrepreneur"
            ? "Entrepreneur"
            : "Investor"}
        </div> */}  {/* esto seria dejar listo el div, para que si el usuario es investor o entrepreneur, se renderize uno u otro*/} 
        <div className="absolute top-[32rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">
          Entrepreneur
        </div>
      </div>
      <div>
        ...
        </h1> */} {/* esto seria dejar listo el h1, para que si el usuario es investor o entrepreneur, se renderize uno u otro*/} 
        <h1 className="text-blue-500 fw-semibold text-xl text-center">
          ¡Get the help you need to start!
        </h1>
        {/* {currentUser.user_role === "entrepreneur" && (  
